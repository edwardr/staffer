...
class Staffer {
	...
	private function load_dependencies() {
		...
		/**
		 * Registers the Staffer post type and initial setup
		 */
	...
	/**
	 * Adds the post type setup function to init
	 *
	 * @since  1.0.0
	 * @access private
	 */
	private function register_staffer() {
		$staffer_setup = new Staffer_Setup();
		$this->loader->add_action( 'init', $staffer_setup, 'create_staff_cpt' );
		$this->loader->add_action( 'after_setup_theme', $staffer_setup, 'theme_thumbnail_support' );
		$this->loader->add_filter( 'template_include', $staffer_setup, 'staff_template_override' );
		$this->loader->add_filter( 'pre_get_posts', $staffer_setup, 'staff_per_page_mod' );
		//$this->loader->add_shortcode( 'init', $staffer_setup, 'staffer_shortcode' );		
	}
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'staff_admin_menu_link' );
