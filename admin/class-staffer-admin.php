...
class Staffer_Admin {
	...
	public function staffer_meta_callback( $post ) {
		...
		echo '<p><label for="staffer_slug">
						<strong>' . __( 'Staff Permalink Slug</strong> (<em>auto-generated if left blank</em>)',
				'staffer' ) . '</strong>
		...
		echo '<p><label for="staffer_staff_order">
						<strong>' . __( 'Order', 'staffer' ) . '</strong>
						<input type="text" id="staffer_staff_order" name="staffer_staff_order" class="widefat" value="' . $field_values['staffer_staff_order'] . '">
					</label></p>';
	...
	public function save_staffer_meta( $post_id ) {
		...
		$data = array(
			...
			'staffer_staff_order'     => esc_attr( $_POST['staffer_staff_order'] ),
		);
	...
	public function staffer_options_page() {
		add_options_page( 'Staffer ' . __( 'Options', 'staffer' ), 'Staffer ' . __( 'Options', 'staffer' ),
			'manage_options', 'staffer', array( $this, 'staffer_output_options' ) );
	}
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        <th scope="row"><?php _e( 'Staff Page ID', 'staffer' ); ?></th>
                        <td><input name="staffer[main_page_id]" type="text"
                                   value="<?php echo $options['main_page_id']; ?>"/>
                            <p class="description"><?php _e( 'The ID of the main staff page. Do not change this unless you know what you are doing.',
									'staffer' ); ?></p>
                        </td>
                    </tr>
			...
			<?php esc_attr_e( 'Thank you for using Staffer. A lot of time went into development. Donations small or large are always appreciated.',
				'staffer' ); ?></p>
